...
namespace ImGui
{
    ...
    IMGUI_API bool CustomCombo(const char* label, int* current_item, const char* const items[], int items_count, int height_in_items);
    IMGUI_API bool CustomCombo(const char* label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items);
...
enum ImGuiTabBarFlags_
{
    ...
    ImGuiTabBarFlags_NoSeparator                    = 1 << 8,   // [CUSTOM] Disable horizontal separator line
